...
If you have downloaded `netinst` binary, [install additional interpreters](http://localhost:4000/install/install.html#install-interpreters) before you start Zeppelin. Or simply run `./bin/install-interpreter.sh --all`.
